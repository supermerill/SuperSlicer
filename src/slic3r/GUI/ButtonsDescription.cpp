...
void ButtonsDescription::FillSizerWithTextColorDescriptions(wxSizer* sizer, wxWindow* parent,
    ...
    m_entries(entries)
{
    ...
    FillSizerWithTextColorDescriptions(sizer, this, &default_colour, &sys_colour, &mod_colour, &phony_colour);
