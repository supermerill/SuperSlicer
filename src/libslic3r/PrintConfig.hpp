...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat,                external_perimeter_extrusion_change_odd_layers))
    ...
    ((ConfigOptionFloat,                infill_extrusion_change_odd_layers))
    ...
    ((ConfigOptionFloat,                perimeter_extrusion_change_odd_layers))
