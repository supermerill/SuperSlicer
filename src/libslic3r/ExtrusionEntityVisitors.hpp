...
class CountEntities : public ExtrusionTreeConstVisitor<false> {
public:
    size_t count(const ExtrusionEntity &coll) { this->traverse(coll); return leaf_number; }
...
#ifdef _DEBUG
class TestCollection : public ExtrusionTreeConstVisitor<true> {
public:
