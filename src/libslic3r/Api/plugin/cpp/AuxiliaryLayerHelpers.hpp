...
object mesh. Support, adhesion features and future helper geometry can publish
there without pretending to be an object layer.
...
perimeter/surface/infill code. What the layer represents and where a plugin
stores its extrusion output remain feature-specific decisions outside this API.
*/
